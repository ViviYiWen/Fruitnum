...
public class Main8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while(num5==num1 || num5==num2||num5==num3||num5==num4) num5= (int)(Math.random()*10);
        ShowDialog(num1,num2,num3,num4,num5);
        Button sure = (Button)findViewById(R.id.sure);
        ImageButton mon = (ImageButton)findViewById(R.id.money);
        sure.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                result = Result(num1,num2,num3,num4,num5);

                if(result==1){
                    findView();//抓使用者姓名
                    t2 = (TextView) findViewById(R.id.mon); //金幣數
                    int upToDbCoin = 0; //要update至DB的金幣數量
                    String flag = "N"; //是否更新DB資料
                    DBHelper dbHelper = new DBHelper(Main8Activity.this);
        ...
        mon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mons=mons-70;
                int ask = (int)(Math.random()*5);//select index number
                if(ask==0){
                    int n=num1;
                ...
                if(ask==4){
                    int n=num5;
                    hints.setText("第五個數字為:"+Integer.toString(n));
                    mon.setText(Integer.toString(mons));
                    layout.setVisibility(View.VISIBLE);
                }
            }
    ...
    //@Override
    public int Result(int num1, int num2, int num3,int num4,int num5){
        int grape=0, apple=0;
        ...
        grape=0;
        apple=0;
        if(a==num1 && b==num2 && c==num3 && d==num4 && e==num5)
            return 1;
        if(a==num2 || a==num3 || a==num4 || a==num5) grape++;
        if(b==num1 || b==num3 || b==num4 || b==num5) grape++;
        if(c==num2 || c==num1 || c==num4 || c==num5) grape++;
        if(d==num1 || d==num2 || d==num3 || d==num5) grape++;
        if(e==num1 || e==num2 || e==num3 || e==num4) grape++;
        if(a==num1) apple++;
        if(b==num2) apple++;
        if(c==num3) apple++;
        if(d==num4) apple++;
        ...
        e = Integer.parseInt(ed5.getText().toString());
        return 0;

    }
    public void ShowDialog(int num1, int num2, int num3,int num4,int num5){
        AlertDialog.Builder builder = new AlertDialog.Builder(Main8Activity.this);
        builder.setTitle("Answer");
        builder.setMessage(Integer.toString(num1)+Integer.toString(num2)+Integer.toString(num3)+Integer.toString(num4)+Integer.toString(num5));
